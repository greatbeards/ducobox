...
async def async_setup_entry(
    ...
    for module in dbb.modules:
        ...
        for sens in module.sensors:
            if isinstance(sens, GenericActuator) and sens.name == "action":
                new_entity = DucoSelectController(coordinator, sens, device_id)
...
class DucoSelectController(CoordinatorEntity, SelectEntity):
    ...
    def __init__(
        ...
        self.sens_obj = sens
        self._attr_current_option = self.sens_obj.value
        self._attr_options = list(self.sens_obj.reverse_mapping.keys())
    ...
    async def async_select_option(self, option: str) -> None:
        ...
        _LOGGER.info("%s Writing %s " % (self.sens_obj.alias, option))
        await self.sens_obj.write(option)
